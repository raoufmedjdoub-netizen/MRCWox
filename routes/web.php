...
Route::group(['as' => 'admin.', 'prefix' => 'admin', 'middleware' => ['auth','auth.admin'], 'namespace' => 'Admin'], function () {
    ...
    # Broadcast message
    Route::resource('broadcast_messages', 'BroadcastMessagesController', ['only' => ['index', 'create', 'store', 'edit', 'update']]);
    Route::any('broadcast_messages/destroy', ['as' => 'broadcast_messages.destroy', 'uses' => 'BroadcastMessagesController@destroy']);
    Route::get('broadcast_messages/users_count', ['as' => 'broadcast_messages.users_count', 'uses' => 'BroadcastMessagesController@getUsersCount']);
