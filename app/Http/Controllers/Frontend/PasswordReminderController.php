	...
	*/
    ...
    public function store()
    {
        try {
            ...
            return Redirect::route('password_reminder.create')->withInput()->with('success', trans('passwords.generic'));

            return Redirect::route('password_reminder.create')->withInput()->with(
                $response == PasswordBroker::RESET_LINK_SENT ? 'success' : 'message',
                trans($response)
            );
        } catch (\Exception $e) {
