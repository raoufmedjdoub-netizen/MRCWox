...
class DeviceFullTransformer extends BaseTransformer {
    ...
    public function transform(Device $entity)
    {
        ...
        $device_data['fuel_type'] = $entity->fuel_type;
        $device_data['fuel_emissions'] = $entity->fuel_emissions;
    ...
    protected function formatServices(Device $entity): ?array
    {
        if ($entity->isExpired())
            return null;
