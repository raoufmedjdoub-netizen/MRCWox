function Devices() {
    ...
    _this.active = function(id, value) {
        ...
        _this.changeVisible(_device, value);
    ...
    _this.activeMulti = function(group_id, value) {
        ...
        _this.changeVisibleGroup(group_id, value);
    };

    _this.changeVisibleGroup = function(group_id, value) {
        $.each( items, function(id, device) {
            ...
            _this.changeVisible(device, value);
        });

        _this.refreshCluster( true );
    };

    _this.changeVisible = function(device, value) {
    ...
    _this.load = function(url, data, firstCallback, lastCallback) {
         dd('devices.load');
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                if (response.pagination.next_page_url)
                    _this.load(response.pagination.next_page_url, data, null, lastCallback);
        ...
        $.ajax({
            ...
            success: function(){
                if (status) {
                    ...
                    _this.changeVisibleGroup(data.group_id, data.active);
                }
            },
        });
    };
