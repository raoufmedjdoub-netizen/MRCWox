function HistoryGraph() {
    ...
    _this.loadData = function(type) {
        ...
        const yMin = Math.min(...app.history.positions.map(pos => pos[sensor.key]));
        const yMax = Math.max(...app.history.positions.map(pos => pos[sensor.key]));
        const yDiff = (1 - yMin / yMax) * 100;
        ...
        if (yDiff < 1) {
            ...
            options.yaxis.max = Math.ceil(yMax + yMargin);
        }
