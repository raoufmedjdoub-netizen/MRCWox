...
return array(
    ...
    'attributes'  => array(
        ...
        'report_tmp_lifetime_days' => 'დღეები ანგარიშების შესანახად',
        'metas' => 'მეტასი',
        'fuel_type' => 'საწვავის ტიპი',
        'fuel_emissions' => 'საწვავის გამონაბოლქვი (გ/კმ)',
        'theme_color' => 'თემის ფერი',
        'custom_theme' => 'მორგებული თემა',
        'custom_theme_color' => 'თემის ფერი',
        'custom_theme_mode' => 'თემის რეჟიმი',
        'weekly_weekday' => 'კვირის დღე',
        'monthly_day' => 'თვის დღე',
    ),
