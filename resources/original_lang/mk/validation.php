...
return array(
    ...
    'attributes'  => array(
        ...
        'report_tmp_lifetime_days' => 'Денови за водење на извештаи',
        'metas' => 'Метас',
        'fuel_type' => 'Тип на гориво',
        'fuel_emissions' => 'Емисиите на гориво (g/km)',
        'theme_color' => 'Боја на темата',
        'custom_theme' => 'Прилагодена тема',
        'custom_theme_color' => 'Боја на темата',
        'custom_theme_mode' => 'Тематски режим',
        'weekly_weekday' => 'Ден од неделата',
        'monthly_day' => 'Ден на месецот',
    ),
