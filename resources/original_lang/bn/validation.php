...
return array(
    ...
    'attributes'  => array(
        ...
        'report_tmp_lifetime_days' => 'তৈরি প্রতিবেদন রাখার দিন',
        'metas' => 'মেটাস',
        'fuel_type' => 'জ্বালানির ধরণ',
        'fuel_emissions' => 'জ্বালানি নির্গমন (গ্রাম/কিমি)',
        'theme_color' => 'থিমের রঙ',
        'custom_theme' => 'কাস্টম থিম',
        'custom_theme_color' => 'থিমের রঙ',
        'custom_theme_mode' => 'থিম মোড',
        'weekly_weekday' => 'সপ্তাহের দিন',
        'monthly_day' => 'মাস দিন',
    ),
