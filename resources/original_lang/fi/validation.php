...
return array(
    ...
    'attributes'  => array(
        ...
        'report_tmp_lifetime_days' => 'Päiviä raporttien pitämiseen',
        'metas' => 'Metat',
        'fuel_type' => 'Polttoainetyyppi',
        'fuel_emissions' => 'Polttoainepäästöt (g/km)',
        'theme_color' => 'Teeman väri',
        'custom_theme' => 'Mukautettu teema',
        'custom_theme_color' => 'Teeman väri',
        'custom_theme_mode' => 'Teematila',
        'weekly_weekday' => 'Viikonpäivä',
        'monthly_day' => 'Kuukausi päivä',
    ),
