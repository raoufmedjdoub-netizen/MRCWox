    ...
    function updateAddress(lat, lng) {
        $.ajax({
            ...
            success: function (res) {
                if (res.status) {
                    $('input[name^="address_lat"]').val(res.location.lat);
                    $('input[name^="address_lng"]').val(res.location.lng);

                    moveMarker(res.location.lat, res.location.lng);

                    if ('id' in res.location) {
                        $('input[name^="address_id"]').val(res.location.id);
                    }

                    if ('address' in res.location) {
                        $('#address_map').find('.filter-option').text(res.location.address);
                        $('input[name="address_text"]').val(res.location.address);
                    }
                } else {
