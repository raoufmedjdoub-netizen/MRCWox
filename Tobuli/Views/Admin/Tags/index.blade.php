...
@section('content')
    <div class="panel panel-default" id="table_tags">
        ...
        <div class="panel-heading">
            <ul class="nav nav-tabs nav-icons pull-right">
                <li role="presentation" class="">
                    <a href="javascript:" type="button" class="" data-modal="tags_create" data-url="{{ route("admin.tags.create") }}">
                        <i class="icon add" title="{{ trans('admin.add_new') }}"></i>
                    </a>
                </li>
            </ul>

            <div class="panel-title">{{ trans('front.tags') }}</div>
...
@section('javascript')
    <script>
        tables.set_config('table_tags', {
            url:'{{ route("admin.tags.table") }}',
            delete_url:'{{ route("admin.tags.destroy") }}'
        });
        function tags_edit_modal_callback() {
            tables.get('table_tags');
        }
        function tags_create_modal_callback() {
            tables.get('table_tags');
        }
    </script>
@stop