<div class="panel panel-default">
    ...
    <div class="panel-body">
        ...
        <div class="map-setting map-setting-10 map-setting-11 map-setting-12">
            <div class="form-group">
        ...
        <div class="map-setting map-setting-10 map-setting-11 map-setting-12">
            <div class="form-group">
                {!! Form::label('here_political_view', trans('validation.attributes.here_political_view'), ['class' => 'col-xs-12 col-sm-4 control-label"']) !!}
                <div class="col-xs-12 col-sm-8">
                    {!! Form::select('here_political_view', $herePoliticalViews, settings('main_settings.here_political_view'), ['class' => 'form-control']) !!}
                </div>
            </div>
        </div>
