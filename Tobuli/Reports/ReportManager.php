...
class ReportManager
{
    public static $types = [
        ...
        88 => Reports\IvmsDriversReport::class,
        89 => Reports\IvmsTravelSheetDriverReport::class,
        90 => Reports\IvmsGeofencesDriversReport::class,
        91 => Reports\IvmsLastConnectionReport::class,
        92 => Reports\IvmsDriversEventsReport::class,
        40 => Reports\StopsReport::class,
        95 => Reports\StopsFilterReport::class,
        ...
        94 => Reports\GeofencesOutReport::class,
        98 => Reports\GeofencesInOutDriversReport::class,
        ...
        29 => Reports\EngineHoursDailyReport::class,
        ...
        93 => Reports\LastLocationReport::class,
        ...
        97 => Reports\UsersDevicesReport::class,
        ...
        96 => Reports\FuelTankUsageSplitReport::class,
    ...
    public function fromEntity(\Tobuli\Entities\Report $report, $data)
    {
        ...
        } elseif ($type->hasAllDevices()) {
            $deviceQuery = $data['user']->accessibleDevices();
        } else {
    ...
    public function from($data)
    {
        ...
        if ( ! empty($data['period_weekdays']))
            $report->setPeriodWeekdays($data['period_weekdays']);
        if ( ! empty($data['period_time_from']))
            $report->setPeriodTimeFrom($data['period_time_from']);
        if ( ! empty($data['period_time_to']))
            $report->setPeriodTimeTo($data['period_time_to']);
