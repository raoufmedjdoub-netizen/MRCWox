...
use Tobuli\Exporters\EntityManager\HeaderContainingInterface;
use Tobuli\Exporters\Util\ParseValueTrait;

class CsvChunkDownloader extends AbstractChunkDownloader implements HeaderContainingInterface
{
    use ParseValueTrait;
    ...
    public function generateFile(Builder $query, array $attributes, string $filename): string
    {
        ...
        $headers = $this instanceof HeaderContainingInterface ? $this->getHeaders($attributes) : $attributes;
