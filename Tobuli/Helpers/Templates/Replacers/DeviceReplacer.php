...
class DeviceReplacer extends Replacer implements PositionAwareInterface
{
    ...
    {
        $sensorReplacer = (new DeviceSensorReplacer())
            ->setUser($this->user)
            ->setPrefix($this->prefix . '.sensor')
