...
return array(
    ...
    'attributes'  => array(
        ...
        'report_tmp_lifetime_days' => 'Дни за съхранение на изготвени отчети',
        'metas' => 'Метас',
        'fuel_type' => 'Вид гориво',
        'fuel_emissions' => 'Емисии на гориво (г/км)',
        'theme_color' => 'Цвят на темата',
        'custom_theme' => 'Персонализирана тема',
        'custom_theme_color' => 'Цвят на темата',
        'custom_theme_mode' => 'Тематичен режим',
        'weekly_weekday' => 'Ден от седмицата',
        'monthly_day' => 'Ден от месеца',
    ),
