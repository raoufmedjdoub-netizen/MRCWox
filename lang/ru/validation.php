...
return array(
    ...
    'attributes'  => array(
        ...
        'report_tmp_lifetime_days' => 'Дней для хранения построенных отчетов',
        'metas' => 'Метас',
        'fuel_type' => 'Тип топлива',
        'fuel_emissions' => 'Выбросы топлива (г/км)',
        'theme_color' => 'Цвет темы',
        'custom_theme' => 'Пользовательская тема',
        'custom_theme_color' => 'Цвет темы',
        'custom_theme_mode' => 'Режим темы',
        'weekly_weekday' => 'Будний день',
        'monthly_day' => 'Месяц день',
    ),
